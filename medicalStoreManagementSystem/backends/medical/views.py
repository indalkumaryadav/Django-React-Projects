...
from .models import Company, CompanyBank, Medicine, MedicalDetails, CompanyAccount, Employee,EmployeeBank, EmployeeSalary, CustomerRequest, Bill, BillDetails

from .serializers import CompanySerliazer, CompanyBankSerializer, MedicineSerliazer,MedicalDetailsSerializer, MedicalDetailsSerializerSimple, CompanyAccountSerializer, EmployeeSerializer,EmployeeBankSerializer, EmployeeSalarySerializer, CustomerSerializer, BillSerializer,BillDetailsSerializer, CustomerRequestSerializer
